...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "APtalk.py"
 
        #Name of program
        self.project_name = "Adventure Posts (v.6.4)"
 
        #Project url
        self.project_url = "None"
 
        #Version of program
        self.project_version = "6.4"
 
        #License of the program
        self.license = "None"
 
        #Auhor of program
        self.author_name = "evil_jaga_genius"
        self.author_email = "None"
        self.copyright = "Created 2014 by evil_jaga_genius"
 
        #Description
        self.project_description = "Adventure Posts"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "APIcon.ico"
        ...
        self.extra_scripts = ['pyganim', 'scenes']
 
        #Zip file name (None will bundle files in exe instead of zip file)
        self.zipfile_name = "APV64W.zip"
