...
chap4 = CutChapter('chapter4.txt', 'chap4', 'scenes.onuKoro3.addHotSpot(scenes.chap5, pygame.Rect(100,60,330,260), False, player); scenes.onuKoro3.delHotSpot(scenes.onuTunnel11, player); scenes.Kaj.editWords("kaj2.txt", player)')
...
chap7_pt2.addTarget(startScene)
